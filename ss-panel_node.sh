...
install_ss_panel(){
	...
	install_soft_for_each
	wget -c https://raw.githubusercontent.com/Chajian/myssr/master/lnmp1.3.zip && unzip lnmp1.3.zip && cd lnmp1.3 && chmod +x install.sh && ./install.sh lnmp
...
install_ss_py_mu(){
	...
	install_soft_for_each(){
		...
		if [[ ${release} = "centos" ]]; then
			...
			curl https://raw.githubusercontent.com/Chajian/myssr/master/get-pip.py -o get-pip.py
			python get-pip.py
